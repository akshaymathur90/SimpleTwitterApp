...
* [X] Compose tweet functionality is build using modal overlay (used full screen Dialog fragment).
...
* [X] Used animations for opening and closing of Compose Tweet Dialog Fragment

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/gKjk8ue.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
